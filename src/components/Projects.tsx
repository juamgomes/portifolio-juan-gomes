      ...
      <div className="grid grid-cols-1 gap-10 place-items-center">
        <div className="flex flex-col sm:flex-row sm:gap-10 gap-6 p-4 w-3/4 h-auto rounded-xl bg-zinc-800">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="sm:text-zinc-500 hidden">Interface do spotify, feita com Next e tailwind</p>
        ...
        <Image src="/Sistema-de-controle-financeiro-img.JPG" width={488} height={288} className="rounded-xl" alt="Print da tela do sistema de controle financeiro"/>
          <div className="flex flex-col gap-4">
            ...
            <p className="sm:text-zinc-500 hidden">Sistema de controle financeiro que registra as entradas e saídas de um valor inicial, subtrai e mostra o total.</p>
            <div className="flex gap-4">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="sm:text-zinc-500 hidden">Rélogio digital simples.</p>
            <div className="flex gap-4">
        ...
        <div className="flex flex-col sm:flex-row sm:gap-10 gap-6 p-4 w-3/4 h-auto rounded-xl bg-zinc-800">
          ...
          <div className="flex flex-col gap-4">
            ...
            <span className="text-zinc-600 font-semibold">HTML - CSS - JS</span>
            <p className="sm:text-zinc-500 hidden">Conversor de temperaturas conversão entre °C e °F, conversão entre °F e °C, conversão entre °F e K, conversão entre K e °F conversão entre °C e K e conversão entre K e °C.</p>
            <div className="flex gap-4">
