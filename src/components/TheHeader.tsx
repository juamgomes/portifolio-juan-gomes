...
export function TheHeader() {
  return (
    <header 
    id='header' 
    className="lg:md:sm:fixed w-full bg-white/90 dark:bg-zinc-main/50 dark:text-white flex flex-col md:sm:flex-row justify-between py-4 sm:py-4 px-4 lg:md:sm:px-28 items-center gap-5"
    >
